$basePath = "DoubleJay.Epi.ConfigurableColorPicker"
...
Compress-Archive -Path $tempBinPath, "$binPath\module.config" -DestinationPath "$binPath\DoubleJay.Epi.ConfigurableColorPicker.zip" -Force
